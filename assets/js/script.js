...
const alturaCorporal = document.querySelector(`#altura`);
const pesoCorporal = document.querySelector(`#peso`)
...
btnCalcular.addEventListener("click", (event)=>{
    ...
    validarInput(alturaCorporal.value, pesoCorporal.value, formPrincipal, tabela, main);
})
